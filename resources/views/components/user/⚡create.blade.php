        ...
        <form wire:submit="createUser" action="#" method="POST" class="space-y-6">
            ...
            <div class="col-span-full">
                @if ($avatar)
                    <div wire:loading.remove wire:target="avatar">
                        <p class="block text-sm/6 font-medium text-gray-900">Preview
                            Avatar</p>
                        <div class="mt-2 w-32 h-32 rounded-base overflow-hidden">
                            <img class="bg-contain" src="{{ $avatar->temporaryUrl() }}" alt="2xl avatar">
                        </div>
                    </div>
                @endif
                <div wire:loading.flex wire:target="avatar"
                    class="justify-center items-center w-32 h-32 text-fg-brand-strong text-xs font-medium rounded-base">
                    <div
                        class="px-2 py-px ring-1 ring-inset ring-brand-subtle text-fg-brand-strong text-xs font-medium rounded-sm bg-brand-softer animate-pulse">
                        loading...</div>
                </div>
            </div>
            ...
            <div>
                <button type="submit"
                    ...
                    <span class="in-data-loading:hidden">Create</span>
                    <div role="status" class="not-in-data-loading:hidden">
                        <svg aria-hidden="true" class="w-5 h-5 text-neutral-quaternary animate-spin fill-brand"
